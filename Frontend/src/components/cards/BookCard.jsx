    ...
    >
      <div className="relative overflow-hidden bg-linear-to-br from-gray-50 to-gray-100">
        ...
        <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex gap-2">
          <button
            ...
            className="w-12 h-12 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-white transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="w-12 h-12 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-red-50 transition-colors group/delete cursor-pointer"
          >
            <Trash2 className="w-6 h-6 text-red-500 group-hover:delete:text-red-600" />
          </button>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
        ...
        <div className="relative">
          <h3 className="font-semibold text-white text-lg leading-tight line-clamp-2 mb-1">{book.title}</h3>
          <p className="text-base text-gray-300 font-medium">{book.author}</p>
        </div>
      </div>
